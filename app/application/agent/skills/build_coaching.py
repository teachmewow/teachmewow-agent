"""Skill: build_coaching — rotation, priorities, cooldowns coaching."""

from .base import SkillDefinition

build_coaching_skill = SkillDefinition(
    name="build_coaching",
    ...
    when_not_to_use=(
        "Build discovery/listing/selection, general chat, greetings, "
        "non-gameplay questions, talent tree viewing"
    ),
    instructions="""\
