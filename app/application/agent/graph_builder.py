...
from .graph.model_factory import GraphModelFactory
from .graph.node_factory import GraphNodeFactory
from .graph.wiring import wire_graph
...
class GraphBuilder:
    ...
    def build(self) -> CompiledStateGraph:
        ...
        models = GraphModelFactory(llm_client=self.llm_client, tools=self.tools).build()
        nodes = GraphNodeFactory(models=models, tools=self.tools).build()
        wire_graph(graph, nodes)
